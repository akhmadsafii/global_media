...
<body>
    ...
    <ul>
        ...
        <li>
            ...
            <a href="{{ route('palindrom.index') }}">Lihat Jawaban</a>
        </li>
        <li>
            Soal No. 5: Menghitung luas lingkaran dan volume bola
            <a href="{{ route('shape.index') }}">Lihat Jawaban</a>
        </li>
        <li>
            Soal No. 6: Treeview Daerah
            <a href="{{ route('treeview.index') }}">Lihat Jawaban</a>
        </li>
        <li style="color: danger">
        ...
        <li>
            ...
            <a href="{{ route('number.index') }}">Lihat Jawaban</a>
        </li>
        <li>
            Soal No. 9: Membuat Crud dengan ajax
            <a href="{{ route('post.index') }}">Lihat Jawaban</a>
        </li>
    </ul>
</body>
